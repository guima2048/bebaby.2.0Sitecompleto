    ...
    <main className="w-full font-sans">
      ...
      <section className="relative w-full h-[90vh] md:h-[400px] flex items-end justify-center bg-cover bg-center" style={{ backgroundImage: "url('/main_impact.png')" }}>
        ...
        <div className="relative z-10 w-full max-w-xl text-left md:text-center px-4 animate-fade-in pb-8">
          <h1 className="text-2xl md:text-4xl font-extrabold mb-5 md:mb-4 leading-tight max-w-xs md:max-w-2xl mx-0 md:mx-auto text-white">Encontre uma Sugar Baby ou um Sugar Daddy</h1>
          <div className="flex flex-col gap-3 items-start md:items-center w-full">
            <a href="/cadastro" className="w-full md:w-auto md:min-w-[180px] px-4 md:px-6 py-2 md:py-3 rounded-full bg-gradient-to-r from-[#a259cb] to-[#6d2c91] text-white font-bold shadow hover:scale-105 transition block mb-2 mx-0 md:mx-auto text-left md:text-center text-base md:text-lg border-2 border-white whitespace-nowrap">Cadastre-se grátis</a>
            <a href="/login" className="w-full md:w-auto md:min-w-[180px] px-4 md:px-6 py-2 md:py-3 rounded-full bg-white/90 text-[#a259cb] font-bold shadow hover:bg-white transition block mx-0 md:mx-auto text-left md:text-center text-base md:text-lg whitespace-nowrap">Entrar</a>
          </div>
        </div>
        {/* Menu hamburguer */}
